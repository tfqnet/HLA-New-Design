...
#import "eAppTabBar.h"
#import "eAppTabBarButton.h"
#import <QuartzCore/QuartzCore.h>

#define DEFAULT_ITEM_HEIGHT 80.0


@implementation eAppTabBar
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    eAppTabBarButton *cell = [tableView dequeueReusableCellWithIdentifier:vtbci];
    if (cell == nil)
    {
        cell = [[eAppTabBarButton alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:vtbci];
    }
